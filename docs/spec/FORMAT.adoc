...
IMPORTANT: This document and the abcrypt encrypted data format are distributed
under the terms of the {cc0-url}[CC0 1.0 Universal] (CC0 1.0). You can copy,
modify, distribute and perform these, even for commercial purposes, all without
asking permission.
